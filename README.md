...
4. В папке [`tasks`](tasks) создайте новый файл `t00_helloworld.py`, на предложение добавить его в систему контроля
   версий *откажитесь*
...
3. В папке [`tasks`](tasks) создайте новый файл `t00_helloworld.py`, на предложение добавить его в систему контроля
   версий *согласитесь*
...
Откройте файл [`tasks/t01_fixme.py`](tasks/t01_fixme.py). Сейчас код, написанный в нем, не работает по множеству причин.
...
Откройте файл [`tasks/t02_fractions.py`](tasks/t02_fractions.py). В нем находится шаблон функции, принимающей 4 целых
